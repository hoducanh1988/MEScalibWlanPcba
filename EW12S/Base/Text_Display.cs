            ...
            lb.Invoke(new MethodInvoker(delegate () {
                if (text != "") {
                    ...
                    if (text.Contains("FAIL") || text.Contains("Fail") || text.Contains("ERROR") || text.Contains("Bai Test Wifi Chưa The Thuc Hien!") || text.Contains("[RED]") || text.Contains("Disconnected")) {
                        ...
                        if (text.Contains("OK") || text.Contains("PASS") || text.Contains("pass") || text.Contains("Pass") || text.Contains("[GRE]") || text.Contains("Connected")) {
                        ...
                        lb.ForeColor = Color.Orange;
                            ...
                            if (text.Contains("Bai test thu:") || text.Contains("Đo chuẩn") || text.Contains("Antena") || text.Contains("MAC Address=") || text.Contains("Firmware version")) {
                        lb.ForeColor = Color.Black;
                    }
                    else
                                if (text.Contains("Checked") || text.Contains("[BLU]")) {
                        //rtb.SelectionFont = new Font(rtb.SelectionFont, FontStyle.Bold);
                        lb.ForeColor = Color.Blue;
                    }
                    else
                                    if (text.Contains("[BOL]")) {
                        lb.ForeColor = Color.Black;
                    }
