...
namespace EW12CG {
    ...
    public partial class frmMain : Form {
        ...
        private void Form1_Load(object sender, EventArgs e) {
            ...
            lblProduct.Text = File.ReadAllText("ew12cg_remain.dll");
            lbl_mac_att.Text = File.ReadAllText("ew12cg_golden.dll");
            string[] lines = File.ReadAllLines("ew12cg_verify.dll");
            if (lines.Length > 0) {
        ...
        public void Read_Config_File(out string xtt_2g, out string xtt_5g) {
            ...
            try {
                ...
                //read mode
                string mode = File.ReadAllText(AppDomain.CurrentDomain.BaseDirectory + "ew12cg_mode.dll");
        ...
        private void btnTinhSuyHao_Click(object sender, EventArgs e) {
            ...
            File.WriteAllText(AppDomain.CurrentDomain.BaseDirectory + "attenuation.dll", $"EW12CG_remain.dll,{maxproduct}");
        ...
        private void cbb_Mode_DropDownClosed(object sender, EventArgs e) {
            ...
            File.WriteAllText(AppDomain.CurrentDomain.BaseDirectory + "ew12cg_mode.dll", new_value);
