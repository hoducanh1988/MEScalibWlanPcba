...
namespace EW12SG {
    ...
    public partial class frmMain : Form {
        ...
        string g_MainConfigFilePath = @"EW12SG_Config\Main-Config.cfg";
        string PathXTTFile2G = "";
        string PathATTFile2G = "";
        string PathXTTFile5G = "";
        string PathATTFile5G = "";
        ...
        private void Form1_Load(object sender, EventArgs e) {
            ...
            lblProduct.Text = File.ReadAllText("ew12sg_remain.dll");
            lbl_mac_att.Text = File.ReadAllText("ew12sg_golden.dll");
            string[] lines = File.ReadAllLines("ew12sg_verify.dll");
            if (lines.Length > 0) {
            ...
            string xtt_2g, xtt_5g;
            Read_Config_File(out xtt_2g, out xtt_5g);
            lblProduct.Text = File.ReadAllText("EW12SG_remain.dll");
            try {
                if (xtt_2g.Contains("\\")) {
        ...
        public void Read_Config_File(out string xtt_2g, out string xtt_5g) {
            ...
            try {
                for (int i = 0; i < readConfigFilePath.Split('\n').Length; i++) {
                    ...
                    if (readConfigFilePath.Split('\n')[i].Contains("XttPath:")) {
                        ...
                        PathATTFile2G = readConfigFilePath.Split('\n')[i + 1].Split(',')[1].Trim();
                        PathXTTFile5G = readConfigFilePath.Split('\n')[i + 1].Split(',')[2].Trim();
                        PathATTFile5G = readConfigFilePath.Split('\n')[i + 1].Split(',')[3].Trim();
                ...
                //read mode
                string mode = File.ReadAllText(AppDomain.CurrentDomain.BaseDirectory + "ew12sg_mode.dll");
                this.cbb_Mode.Text = mode;
                
                switch (mode) {
                    case "Calibration": { 
                            g_mode = 0; 
                            xtt_2g = PathXTTFile2G;
                            xtt_5g = PathXTTFile5G;
                    ...
                    case "Attenuation": {
                            g_mode = 1; 
                            xtt_2g = PathATTFile2G; 
                            xtt_5g = PathATTFile5G;
        ...
        private void reset_a_Result() {
            ...
            lbl_aSwitchMode2G.Text = "--"; lbl_aSwitchMode2GTime.Text = "";
            lbl_Att2G.Text = "--"; lbl_Att2GTime.Text = "";
        ...
        private void reset_v_Result() {
            ...
            lbl_vSwitchMode2G.Text = "--"; lbl_vSwitchMode2GTime.Text = "";
            lbl_Verify2G.Text = "--"; lbl_Verify2GTime.Text = "";
        ...
        private void btnTinhSuyHao_Click(object sender, EventArgs e) {
            ...
            File.WriteAllText(AppDomain.CurrentDomain.BaseDirectory + "attenuation.dll", $"EW12SG_remain.dll,{maxproduct}");
        ...
        private void cbb_Mode_DropDownClosed(object sender, EventArgs e) {
            ...
            File.WriteAllText(AppDomain.CurrentDomain.BaseDirectory + "ew12sg_mode.dll", new_value);
