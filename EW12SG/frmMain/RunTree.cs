...
namespace EW12SG {
    public partial class frmMain : Form {
        ...
        private bool calibWlan() {
            ...
            File.WriteAllText("ew12sg_remain.dll", lblProduct.Text);
        ...
        private bool measureAtt() {
            ...
            lbl_mac_att.Text = "";
            File.WriteAllText("ew12sg_golden.dll", "");
            File.WriteAllText("ew12sg_verify.dll", "");
        ...
        END:
            ...
            if (r) {
                ...
                File.WriteAllText("ew12sg_golden.dll", g_macEth0);
            ...
            if (r) {
                ...
                if (z == false) {
                    this.Invoke(new Action(() => {
                        ...
                        File.AppendAllLines(AppDomain.CurrentDomain.BaseDirectory + "ew12sg_verify.dll", new string[] { l.Text });
                    }));
                }
        ...
        private bool _calibAndVerify(bool is2G) {
            try {
                ...
                if (_testTree != null) {
                    ...
                    string golden_file = string.Format("ew12sg_Golden\\GOLDEN_{0}.txt", g_macEth0.ToUpper());
        ...
        bool _getGoldenStandardValues(string mac_ethernet) {
            ...
            string golden_file = string.Format("ew12sg_Golden\\GOLDEN_{0}.txt", mac_ethernet.ToUpper());
            string golden_file_full_name = Path.Combine(dir, golden_file);
